...
def bkapp(doc):
    ...
    doc.add_root(column(column(buttons_row,row_four,row_five,Spacer(height=50), row_six,row_seven, sizing_mode='scale_width', css_classes=['upper-flex']), sizing_mode='scale_width', margin=(0,30,0,0)))
...
def bk_worker():
    ...
    bokeh_tornado = BokehTornado({'/bkapp': bkapp}, extra_websocket_origins=["localhost:80", "0.0.0.0:80", "localhost:8000", "0.0.0.0:8000", "localhost:5000", "0.0.0.0:5000"])
